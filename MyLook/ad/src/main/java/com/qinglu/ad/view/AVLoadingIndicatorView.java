...
import com.qinglu.ad.view.indicators.BallPulseIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        mMinWidth = GTools.dip2px(48);
        mMaxWidth = GTools.dip2px(96);
        mMinHeight = GTools.dip2px(48);
        mMaxHeight = GTools.dip2px(96);
