...
public final class ActionUtils {
	...
	static {
		...
		for (Object[] action : ActionUtils.ALL)
	...
	static public int compare(String action1, String action2) {
		int idx1 = CollectionUtils.getHashMapIndex(ActionUtils.MAP, action1);
		int idx2 = CollectionUtils.getHashMapIndex(ActionUtils.MAP, action2);
	...
	public static String getIntentName(Context context, String action) {
		Object[] data = MAP.get(action);
		if (data == null)
			return action;
		return (data[1] != null) ? context.getResources().getString((Integer)data[1]) : (String)data[0];
	}
}