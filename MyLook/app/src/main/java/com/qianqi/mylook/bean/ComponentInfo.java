...
public class ComponentInfo implements Parcelable {
	...
	public EnhancePackageInfo enhancePackageInfo;
	...
	public String toString() {
		return String.format("%s/%s", enhancePackageInfo.packageName, componentName);
	}

	@Override
    public int hashCode() {
		return this.enhancePackageInfo.hashCode() ^ this.componentName.hashCode();
	}
	...
	public String getLabel() {
		if (componentLabel != null && !componentLabel.equals(""))
			...
			return enhancePackageInfo.getLabel();
	}
	...
	public void writeToParcel(Parcel dest, int flags) {
		enhancePackageInfo.writeToParcel(dest, flags);
	...
	public static final Creator<ComponentInfo> CREATOR
	= new Creator<ComponentInfo>()
	{
	...
	private ComponentInfo(Parcel in) {
		enhancePackageInfo = EnhancePackageInfo.CREATOR.createFromParcel(in);
